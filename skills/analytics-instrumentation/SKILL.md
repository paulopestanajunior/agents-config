...
description: >-
  Design stable analytics measurement contracts: tracking plans, event
  taxonomy, naming conventions, event/property schemas, identity model,
  anonymous-to-authenticated lifecycle, source ownership, client/server
  ownership, destination mapping, required and optional properties, schema
  evolution, deprecation, versioning, consent classification, deduplication
