...
description: >-
  Design and review cloud architecture across GCP/AWS/Azure trade-offs, IAM,
  networking, serverless, containers, managed services, storage, compute,
  scalability, resilience, multi-region considerations, cost-aware
  architecture, security boundaries, and environment design.
---
