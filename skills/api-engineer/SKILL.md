...
name: api-engineer
description: >-
  Design and review reliable APIs: REST contracts, FastAPI-style services
  where applicable, versioning, idempotency, retries, pagination, auth
  boundaries, error models, rate limiting, webhooks, external integrations,
  backward compatibility, validation, observability, and integration testing.
---
