...
description: >-
  Design and review observability for agentic systems: runtime traces,
  trajectories, tool calls, model calls, context size, latency, token/cost
  usage, retries, failures, routing, handoffs, memory, and incident diagnosis.
---
