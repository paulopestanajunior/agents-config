...
description: >-
  Design and review operational databases: relational database design, schema
  design, normalization/denormalization, indexing, query performance,
  transactions, locking, concurrency, migrations, replication, consistency,
  integrity constraints, and database reliability.
---
