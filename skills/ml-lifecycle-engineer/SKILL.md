---
name: ml-lifecycle-engineer
description: >-
  Own trained models after a candidate exists: model and dataset registry,
  versioning, promotion path, serving and inference deployment, retraining
  triggers, champion/challenger and shadow runs, rollback, production drift and
  decay, and training/serving consistency.
---
