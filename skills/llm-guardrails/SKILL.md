...
name: llm-guardrails
description: >-
  Design and review the enforcement layer around model and tool execution:
  input filtering, output validation, prompt and tool injection defense, PII
  redaction before the model, refusal policy implementation, cost and loop
  ceilings, and action allowlists.
---
