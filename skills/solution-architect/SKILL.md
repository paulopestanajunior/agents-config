...
description: >-
  Design and review end-to-end technical solutions across business
  requirements, applications, services, APIs, integrations, data flows,
  databases, queues/events, AI/ML components, agentic systems, cloud/platform,
  security boundaries, observability, reliability, operations, deployment, and
  cost constraints. Use when the question is how the complete solution fits
