...
description: >-
  Review and rewrite text that sounds overly generated, generic, mechanical,
  repetitive, corporate, or stylistically unnatural. Use when the goal is to
  preserve meaning while improving naturalness, specificity, rhythm, voice,
  clarity, and human editorial quality.
---
