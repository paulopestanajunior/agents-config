...
description: >-
  Analyze product behavior and performance: funnels, activation, retention,
  cohorts, engagement, conversion, experimentation, product metrics,
  north-star metrics, behavioral segmentation, metric definitions,
  instrumentation requirements, Amplitude, Mixpanel, PostHog, and causal
