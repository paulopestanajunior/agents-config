...
description: >-
  Design and review automated test strategy: unit, integration, contract,
  end-to-end tests, pytest patterns, fixtures, mocks/stubs/fakes, flaky test
  diagnosis, regression tests, isolation, coverage quality, test
  pyramid/portfolio, CI execution, and deterministic testing.
---
