...
description: >-
  Evaluate end-to-end agent behavior and task completion across realistic
  tasks: success criteria, baseline comparison, tool behavior, instruction
  following, autonomy, recovery, safety, latency, token/cost usage,
  regressions, and acceptance thresholds.
---
